---
title: "Manual for the kernel matrix list"
author: "Haziq Jamil"
date: "2017-01-10"
...
devtools::load_all("/Users/haziqjamil/Desktop/GitHub/iprior")
```

## Introduction

Adapted from Jamil \& Bergsma (2016). The M-step involving the scale parameters $\boldsymbol\lambda$ in the EM algorithm for I-prior models can be found in closed-form in the following situations:
